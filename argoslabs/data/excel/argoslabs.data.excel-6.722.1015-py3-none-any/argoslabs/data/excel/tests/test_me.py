...
class TU(TestCase):
    ...
    def test0210_read_all(self):
        ...
        if sg is None:  # Not in debug mode
            ...
            return
        try:
            r = main(r'C:\Users\vivans\Desktop\test\【C】00.受注リスト20240719(マージ)(RPA).xlsx', '--sheet', 'テーブル2',
                     '--keep-blank',
                     '--data-only',
                     '--outfile', self.out,
                     '--errfile', self.err)
    ...
    def test0490_sheet_tailing_empty_commas_csv(self):
        ...
        if sg is None:  # Not in debug mode
            ...
            return
        try:
            r = main(r'C:\Users\argos\Desktop\ASJ\ASJ-620\sample.xlsx','--sheet', 'SampleSheet',
                     '--range','I5:I5',
                     # '--keep-blank',
                     '--data-only',
                     '--outfile', self.out,
    ...
    #         return
    #     try:
    #         xls = r"C:\Users\argos\Documents\★0623_카드청구서.xlsx"
    #         for i in range(20):
    #             r = main(xls,
    #                      '--sheet', "sodamk",
    #                      '--range', "B1:B1",
    ...
    #     #     return
    #     try:
    #         xls = r"C:\Users\vivans\Downloads\Catalog_v2.csv"
    #         xls2 = r'C:\Users\vivans\Desktop\test\lock (3).xlsx'
    #         xls3 = r'C:\Users\vivans\Desktop\test\PassTest2.xlsx'
    #         r = main(xls2,
    #                  '--remove-password',
    #                  '--password','test',
    #                  '--outfile', self.out,
    ...
    #     #     return
    #     try:
    #         r = main(r'C:\Users\vivans\Desktop\test\test.xlsx',
    #                  '--sheet', 'Sheet1',
    #                  '--overwrite',
    #                  '--password2', 'testpass',
    #                  '--outfile', self.out,
