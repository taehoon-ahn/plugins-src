...
class TU(TestCase):
    ...
    def test0100_excel(self):
        try:
            r = main('randomalphabet.xlsx', 'img.tif', '--cell', 'f10', '--dwidth',
                     '100',
    ...
    def test0110_pdf(self):
        try:
            r = main('randomalphabet.pdf', 'img.tif', '--output', 'demo.pdf',
                     '--dheight', '100')
            self.assertTrue(r == 0)
        except ArgsError as e:
            sys.stderr.write('\n%s\n' % str(e))
    ...
    def test0120_docx(self):
        try:
            r = main('randomalphabet.docx', 'img.bmp', '--output', 'demo.docx',
    ...
    def test0130_pptx(self):
        try:
            r = main('randomalphabet.pptx', 'img.tif', '--output', 'demo.pptx', '--dx',
    ...
    def test0140_pdf(self):
        try:
            r = main('randomalphabet.pdf', 'colorimg.png', '--output', 'demo.pdf',
                     '--dx',
